...
// Repeat the array so animation feels infinite
...
export default function TestimonialBanner() {
  ...
  return (
    <section className="my-container section pb-10 pt-16 md:px-0">
      ...
      <div className="max-w-5xl mx-auto mt-10 flex gap-10 lg:justify-between  overflow-x-auto lg:overflow-hidden ">
        ...
        <div className="flex gap-8 animate-banner-scroll" style={{width: `432px`}}>
            ...
            <div className="h-[70vh] relative">
              <img
                src="../author/6596ea8404d31b14e01e406f_reviews-man.avif"
              ...
              <div className="flex justify-start gap-6">
                <div className="rounded-full p-4 border border-white" onClick={handlePrev}> 
                    <FaLessThan/>
                </div>
                <div className="rounded-full p-4 border border-white" onClick={handleNext}>
                        <FaGreaterThan />
                </div>
              </div>
              </div>
          ...
          {repeatedReviews.map((review, idx) => (
            <div
              key={idx}
              className="hidden lg:flex bg-[#3719CA] rounded-2xl p-7 w-[400px]  flex-shrink-0 h-[40vh] lg:h-[60vh] flex-col shadow-lg lg:mr-20 xl:mr-40"
            >
