...
// One static import path for DRY lazy image usage everywhere
...
const CARDS = [
  {
    tag: "marketplace",
    flagImageSrc:
      "../testimonials/flags/66ab56714b5a386eb1600483_flag-Switzerland.avif",
    works: "HomeQ's 67% yearly growth and acquisition by a $7B company",
    starIcon:
      "https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/63ff2cb2a75a0475348a5685_icon-star.svg",
    text:
      "The team at Halo Lab crafted intuitive websites and landing pages. Their attention to detail and client focus were remarkable.",
    authorImage:
      "../testimonials/author/6728d40dd2f5fa23e0cf2409_review-ava_Peter-Hedlund.avif",
    authorName: "Peter Hedlund",
    authorDescription: "SVP, Marketing",
    workImage:
      "./testimonials/works/6719144ea7fcb629b8c71ae6_works-audit-HomeQ.avif"
  },
  {
    tag: "TRANSPORTATION & LOGISTICS",
    flagImageSrc:
      "../testimonials/flags/66ab5671b25d942cf11814bb_flag-France.avif",
    works: "Linkbycar raised €1.4M in funding and strengthened its market position",
    starIcon:
      "https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/63ff2cb2a75a0475348a5685_icon-star.svg",
    text:
      "Halo Lab offers a broad mix of expertise and always comes up with excellent solutions. They completed the project efficiently and on schedule.",
    authorImage:
      "../testimonials/author/67e5100e2eed105d01a8cc6b_review-ava_Saidou-Soumare2.avif",
    authorName: "Saidou Soumare",
    authorDescription: "CTO at Linkbycar",
    workImage:
      "./testimonials/works/67add53c74d185f9063e5a8d_results-Linkbycar.avif"
  },
  {
    tag: "real estate",
    flagImageSrc:
      "../testimonials/flags/67c06382ce089ee9cac4fabf_flag-Portugal.avif",
    works: "Strong branding helped Relocate Now gain 1,400+ nomads in a year",
    starIcon:
      "https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/63ff2cb2a75a0475348a5685_icon-star.svg",
    text:
      "Halo Lab follows a systematic planning approach to reach targets on time. Communication throughout was seamless and highly valuable.",
    authorImage:
      "../testimonials/author/671f8415c64a592b60341289_review-ava_Alvaro-Araujo.avif",
    authorName: "Alvaro Araujo",
    authorDescription: "Founder & CEO, Relocate Now",
    workImage:
      "./testimonials/works/6812015839e18a614d927c94_results-Relocate2.avif"
  },
  {
    tag: "SAAS",
    flagImageSrc:
      "../testimonials/flags/66ab5672df09cccbbfafb714_flag-USA.avif",
    works: "WeSpire raised $13M in its latest funding round and $23.7M in total",
    starIcon:
      "https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/63ff2cb2a75a0475348a5685_icon-star.svg",
    text:
      "After Halo Lab revamped our platform, traffic improved by 35%, and user engagement increased with a reduced bounce rate of 20%.",
    authorImage:
      "../testimonials/author/65856676d93b5382ccf5c3e8_ava-justin-lopez.avif",
    authorName: "Justin Lopez",
    authorDescription: "DGM @ Wespire",
    workImage:
      "./testimonials/works/6719144e5f1284ab31bccfd8_works-audit-WeSpire.avif"
  },
  {
    tag: "Education",
    flagImageSrc:
      "../testimonials/flags/67bda237b702f3e3c050d9ee_flag-UAE.avif",
    works: "Thoughtful UI/UX helped ASI app surpass 4 million student queries",
    starIcon:
      "https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/63ff2cb2a75a0475348a5685_icon-star.svg",
    text:
      "We developed a student-centric app with user-friendly design, transforming difficult processes into fun and easy experiences, increasing retention.",
    authorImage:
      "../testimonials/author/65856676d93b5382ccf5c3e8_ava-justin-lopez.avif",
    authorName: "UX/UI Design",
    authorDescription: "2 Months",
    workImage:
      "./testimonials/works/681200a7712ca3755b94a098_results-ASI.avif"
  },
  {
    tag: "HEALTHCARE",
    flagImageSrc:
      "../testimonials/flags/66ab5671023787dcce263398_flag-Austria.avif",
    works: "Nyra Health achieved a 16% traffic increase with our fresh design solutions",
    starIcon:
      "https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/63ff2cb2a75a0475348a5685_icon-star.svg",
    text:
      "Halo Lab delivered our healthcare platform, including industry-specific pages, adapting quickly to our needs and meeting all deadlines.",
    authorImage:
      "../testimonials/author/663ce808d9ada3c120697131_review-ava_Mario-Zusag.avif",
    authorName: "Mario Zusag",
    authorDescription: "CTO, nyra health",
    workImage:
      "./testimonials/works/678a885d60016fcf4a0ee5b5_results-NyraHealth.avif"
  }
];
...
function TestimonialCard() {
  ...
  // For accessibility: keyboard arrow navigation
  ...
  const prev = () => setCurrentIndex((currentIndex - 1 + cardsCount) % cardsCount);
  const next = () => setCurrentIndex((currentIndex + 1) % cardsCount);
